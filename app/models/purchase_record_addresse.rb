class PurchaseRecordAddresse
  ...
  attr_accessor :user_id, :item_id, :post_code, :from_id, :town, :street, :building, :phone, :purchase_record_id
  ...
  def save
    ...
    Addresse.create(post_code: post_code, from_id: from_id, town: town, street: street, building: building, phone: phone, purchase_record_id: @purchase_record.id)
  end
end
